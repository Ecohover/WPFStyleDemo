...
namespace MyStyle.Feature
{
	public sealed class ScrollSynchronizer
	{
		...
		public static void RemoveFromVerticalScrollGroup(string verticalGroupName, ScrollViewer scrollViewer)
		{
		...
		public static void AddToVerticalScrollGroup(string verticalGroupName, ScrollViewer scrollViewer)
		{
			if (verticalScrollGroups.ContainsKey(verticalGroupName))
			{
